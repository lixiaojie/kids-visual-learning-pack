...
| [Card OS Trusted Upstream Compiler Design](superpowers/specs/2026-07-31-cognitive-card-trusted-upstream-compiler-design.md) | API-01 trusted upstream compiler and core snapshot design | Draft |
