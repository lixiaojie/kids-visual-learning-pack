const characters = [
  {
    ...
    image: "assets/characters/main-boy.png",
    tags: ["成长", "勇气", "新能力"]
  },
  {
    id: "girl-companion",
    ...
    image: "assets/characters/girl-companion.png",
    tags: ["朋友", "节奏", "理解"]
  },
  {
    id: "older-veteran",
    ...
    image: "assets/characters/older-veteran.png",
    tags: ["经验", "守护", "责任"]
  },
  {
    id: "worn-mentor",
    ...
    image: "assets/characters/worn-mentor.png",
    tags: ["导师", "鼓励", "重新学习"]
  },
  {
    id: "pig-sidekick",
    ...
    image: "assets/characters/pig-sidekick.png",
    tags: ["幽默", "轻松", "卡通"]
  },
  {
    ...
    image: "assets/characters/tech-girl-giant-robot.png",
    tags: ["科技", "合作", "伙伴"]
  },
  {
    id: "noir-detective",
    ...
    image: "assets/characters/noir-detective.png",
    tags: ["侦探", "黑白", "风格"]
  },
  {
    id: "future-guardian",
    ...
    image: "assets/characters/future-guardian.png",
    tags: ["规则", "秩序", "分歧"]
  }
];

const relations = [
  { image: "assets/characters/father.png", label: "爸爸 → 黑红少年", text: "爱他，也担心他", type: "family" },
  { image: "assets/characters/mother.png", label: "妈妈 → 黑红少年", text: "希望他做真实的自己", type: "family" },
  { image: "assets/characters/uncle-secret.png", label: "叔叔 ↔ 黑红少年", text: "亲近，但有秘密", type: "family-conflict" },
  { image: "assets/relationships/main-girl.png", label: "白帽女孩 ↔ 黑红少年", text: "互相理解", type: "friend" },
  { image: "assets/relationships/main-mentor.png", label: "外套导师 → 黑红少年", text: "教他，也鼓励他", type: "mentor" },
  { image: "assets/characters/future-guardian.png", label: "未来守护者 ↔ 黑红少年", text: "规则与选择的冲突", type: "conflict" },
  { image: "assets/characters/portal-troublemaker.png", label: "传送门麻烦 → 黑红少年", text: "小麻烦变成大问题", type: "problem" }
];
...
const storyOne = [
  ["01-new-school.png", "新学校", "他来到新学校，有点不适应。", "普通生活是冒险的起点。", "紧张", "你有去新地方的经历吗？"],
  ["02-graffiti-tunnel.png", "地下涂鸦", "他和叔叔有一个秘密基地。", "建立亲近关系。", "放松", "你有喜欢和家人一起做的事吗？"],
  ["03-glowing-bug.png", "发光小虫", "奇怪的事情开始了。", "新能力的触发。", "惊讶", "你觉得他这时害怕还是好奇？"],
  ["04-sticky-accident.png", "黏住课本", "新能力一点也不听话。", "能力先带来混乱。", "慌张", "新本领不好控制时怎么办？"],
  ["05-circular-machine.png", "圆形机器", "城市开始变得不稳定。", "外部危机出现。", "不安", "你看到危险会先找谁帮忙？"],
  ["06-protector-falls.png", "英雄倒下", "他第一次感到责任很重。", "成长的痛点。", "难过", "英雄可以难过吗？"],
  ["07-meet-mentor.png", "遇到导师", "一个不完美的大人帮助他。", "导师关系建立。", "疑惑", "老师也会犯错吗？"],
  ["08-allies-portals.png", "伙伴出现", "原来还有很多同伴。", "世界变大。", "惊喜", "你会先认识哪个伙伴？"],
  ["09-uncle-shadow.png", "叔叔影子", "亲近的人也有秘密。", "复杂人物关系。", "混乱", "喜欢一个人就要赞成他所有选择吗？"],
  ["10-father-door.png", "门外鼓励", "家人的话给了他力量。", "情感支撑。", "被支持", "你希望家人怎样鼓励你？"],
  ["11-leap-of-courage.png", "勇敢一跃", "他终于相信自己。", "成长核心瞬间。", "勇敢", "哪句话能让你更勇敢？"],
  ["12-protect-city.png", "守护城市", "他用自己的方式留下来。", "完成第一阶段成长。", "自信", "自己的方式是什么意思？"]
].map((item, index) => makeStoryItem("story-01", item, index));

const storyTwo = [
  ["01-girl-world.png", "鼓手少女", "她也有自己的孤单。", "先建立伙伴的内心。", "孤单", "朋友也会有自己的烦恼吗？"],
  ["02-missing-friend.png", "想念朋友", "主角想再次见到朋友。", "情感动机。", "想念", "想朋友时可以怎么做？"],
  ["03-portal-trouble.png", "黑洞麻烦", "小麻烦开始变大。", "问题角色出现。", "困惑", "小问题什么时候会变大？"],
  ["04-rooftop-reunion.png", "高处重逢", "两个朋友再次见面。", "情感连接。", "开心", "重逢时你会先说什么？"],
  ["05-multiverse-tunnel.png", "彩色通道", "他进入更大的世界。", "多元世界展开。", "惊奇", "你想进入什么样的世界？"],
  ["06-city-rescue.png", "城市救援", "他先选择救人。", "行动优先于规则。", "坚定", "看到别人需要帮助时怎么办？"],
  ["07-headquarters.png", "巨大总部", "他见到很多冒险者。", "系统与组织出现。", "震撼", "人很多就一定更安全吗？"],
  ["08-rule-explanation.png", "解释规则", "有人告诉他必须怎样。", "规则压力出现。", "压力", "规则需要解释吗？"],
  ["09-choose-family.png", "选择家人", "他不想放弃重要的人。", "核心价值冲突。", "坚定", "重要的人遇到危险怎么办？"],
  ["10-headquarters-chase.png", "总部追逐", "大家意见不同。", "团队和个人冲突。", "紧张", "意见不同还能做朋友吗？"],
  ["11-wrong-city.png", "不对劲城市", "他回到一个奇怪地方。", "悬念和危机。", "不安", "哪里像家又不完全对？"],
  ["12-team-up.png", "朋友组队", "朋友们决定帮助他。", "新阶段开启。", "希望", "真正的朋友会怎么做？"]
].map((item, index) => makeStoryItem("story-02", item, index));

const problemCards = [
  {
    name: "巨大机器人物",
    image: "assets/characters/machine-figure.png",
    want: "想修复自己的遗憾",
    mistake: "用危险机器影响城市",
    lesson: "不能因为难过就伤害别人",
    emotion: "难过"
  ...
  {
    name: "有秘密的叔叔",
    image: "assets/characters/uncle-secret.png",
    want: "想保护自己，也关心主角",
    mistake: "隐藏身份，做了错误选择",
    lesson: "喜欢的人也可能犯错",
    emotion: "害怕"
  ...
  {
    name: "黑洞小丑式人物",
    image: "assets/characters/portal-troublemaker.png",
    want: "想被重视",
    mistake: "把怨气变成麻烦",
    lesson: "被忽视的情绪会变大",
    emotion: "被忽视"
...
const generatedAssetManifest = [
  "assets/cast/cast-lineup.png",
  "assets/characters/main-boy.png",
  "assets/characters/girl-companion.png",
  "assets/characters/older-veteran.png",
  "assets/characters/worn-mentor.png",
  "assets/characters/pig-sidekick.png",
  "assets/characters/tech-girl-giant-robot.png",
  "assets/characters/noir-detective.png",
  "assets/characters/future-guardian.png",
  "assets/characters/father.png",
  "assets/characters/mother.png",
  "assets/characters/uncle-secret.png",
  "assets/characters/machine-figure.png",
  "assets/characters/portal-troublemaker.png",
  "assets/relationships/main-girl.png",
  "assets/relationships/main-mentor.png",
  "assets/relationships/main-family.png",
  "assets/relationships/main-veteran.png",
  "assets/story-01/01-new-school.png",
  "assets/story-01/02-graffiti-tunnel.png",
  "assets/story-01/03-glowing-bug.png",
  "assets/story-01/04-sticky-accident.png",
  "assets/story-01/05-circular-machine.png",
  "assets/story-01/06-protector-falls.png",
  "assets/story-01/07-meet-mentor.png",
  "assets/story-01/08-allies-portals.png",
  "assets/story-01/09-uncle-shadow.png",
  "assets/story-01/10-father-door.png",
  "assets/story-01/11-leap-of-courage.png",
  "assets/story-01/12-protect-city.png",
  "assets/story-02/01-girl-world.png",
  "assets/story-02/02-missing-friend.png",
  "assets/story-02/03-portal-trouble.png",
  "assets/story-02/04-rooftop-reunion.png",
  "assets/story-02/05-multiverse-tunnel.png",
  "assets/story-02/06-city-rescue.png",
  "assets/story-02/07-headquarters.png",
  "assets/story-02/08-rule-explanation.png",
  "assets/story-02/09-choose-family.png",
  "assets/story-02/10-headquarters-chase.png",
  "assets/story-02/11-wrong-city.png",
  "assets/story-02/12-team-up.png",
  "assets/boards/role-gallery-bg.png",
  "assets/boards/relationship-map-bg.png",
  "assets/boards/power-atlas-bg.png",
  "assets/boards/story-01-board.png",
  "assets/boards/story-02-board.png",
  "assets/boards/problem-cards-bg.png",
  "assets/boards/multiverse-books-bg.png",
  "assets/boards/choice-balance-bg.png",
  "assets/boards/art-lab-bg.png",
  "assets/boards/creation-card-bg.png"
];
